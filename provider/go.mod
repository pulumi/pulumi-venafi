...
replace (
	...
	github.com/terraform-providers/terraform-provider-venafi => github.com/Venafi/terraform-provider-venafi v0.16.1
)

require (
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.33.0
	github.com/pulumi/pulumi/sdk/v3 v3.44.2
	github.com/terraform-providers/terraform-provider-venafi v0.16.1
)
...
require (
	...
	github.com/Venafi/vcert/v4 v4.22.0 // indirect
