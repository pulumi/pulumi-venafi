...
public class SshCertificate extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return The private key for the SSH certificate if generated by CyberArk Machine Identity Service.
     * 
     */
     ...
     */
    public SshCertificate(java.lang.String name) {
     ...
     */
    public SshCertificate(java.lang.String name, SshCertificateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SshCertificate(java.lang.String name, SshCertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("venafi:index/sshCertificate:SshCertificate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SshCertificate(java.lang.String name, Output<java.lang.String> id, @Nullable SshCertificateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("venafi:index/sshCertificate:SshCertificate", name, state, makeResourceOptions(options, id), false);
    }

    private static SshCertificateArgs makeArgs(SshCertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SshCertificateArgs.Empty : args;
    }
     ...
     */
    public static SshCertificate get(java.lang.String name, Output<java.lang.String> id, @Nullable SshCertificateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
