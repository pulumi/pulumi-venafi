...
type Provider struct {
	...
	TsgId pulumi.StringPtrOutput `pulumi:"tsgId"`
...
// The Palo Alto Networks Next-Gen Trust Security (NGTS) TSG ID to use when issuing a token. Only used if platform is detected as 'ngts'
func (o ProviderOutput) TsgId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Provider) pulumi.StringPtrOutput { return v.TsgId }).(pulumi.StringPtrOutput)
}
